...
2. Apply the following workaround due to a typo in the ansible EEE image. Replace:
    *registry.redhat.io/rhoso-edpm-beta/openstack-ansible-ee-rhel9:1.0.0* by
    *registry.redhat.io/rhoso-edpm-beta/ee-openstack-ansible-ee-rhel9:1.0.0* in the following csvs: 
```
